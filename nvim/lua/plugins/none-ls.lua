  ...
  config = function()
    ...
    null_ls.setup({
      sources = {
        ...
        require("none-ls.diagnostics.eslint_d").with(opts.eslint_diagnostics),
        require("none-ls.formatting.eslint_d").with(opts.eslint_formatting),
        ...
        require("none-ls.code_actions.eslint_d").with(opts.eslint_diagnostics),
      },
      on_attach = on_attach,
    })
  end,
